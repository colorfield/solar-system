...
package com.warmforestflash.ui
{
	...
	{
		// correctif
		private var BOX_WIDTH:int = 580;
		private var BOX_HEIGHT:int = 375;
		private var BOX_RIGHT_MARGIN:int = 20;
		...
		//============================================================================================================================
		public function ScrollBar(c:DisplayObjectContainer,
								  tc:uint, 
								  gc:uint,
								  gpc:uint, 
								  grip:uint, 
		...
		//============================================================================================================================
		{
			...
			_stageW = BOX_WIDTH + BOX_RIGHT_MARGIN;
			_stageH = BOX_HEIGHT;
			adjustSize();
		}
